...
class ThemeController extends Controller
{
    ...
    //     // get value gambar
    //     $gambar = [
    //         'namaFile' => $this->lib('randName')->getRandomName($_FILES['image-theme']['name']),
    //         'tmpName' => $_FILES['image-theme']['tmp_name'],
    //         'typeFile' => $_FILES['image-theme']['type'],
    //         'sizeFile' => $_FILES['image-theme']['size'],
    //         'msgError' => $_FILES['image-theme']['error'],
    //     ];
